  ...
  Future<void> _submitReview() async {
    ...
    try {
      ...
      final review = Review(
        ...
        reviewedUserId: widget.walkerId,
        reviewedUserName: widget.walkerName,
        reviewerType: 'owner',
        reviewedUserType: 'walker',
        rating: _rating,
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Share your experience with ${widget.walkerName}...',
                    hintStyle: TextStyle(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      elevation: 4,
                      shadowColor: const Color(0xFFFBBF24).withAlpha((0.4 * 255).round()),
                    ),
                    child: _isSubmitting
                        ? const SizedBox(
                            height: 20,
