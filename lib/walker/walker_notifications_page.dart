...
class WalkerNotificationsPage extends StatefulWidget {
  const WalkerNotificationsPage({super.key});

  @override
  State<WalkerNotificationsPage> createState() => _WalkerNotificationsPageState();
}

class _WalkerNotificationsPageState extends State<WalkerNotificationsPage>
  ...
  Future<void> _handleNotificationTap(AppNotification notification) async {
    ...
    if (notification.bookingId != null &&
        (notification.type == NotificationType.bookingRequest ||
